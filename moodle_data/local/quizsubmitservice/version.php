...
$plugin->component = 'local_quizsubmitservice'; // Nome do componente do plugin.
$plugin->version = 2024062600;           // Data de liberação do plugin (formato YYYYMMDDXX).
...
$plugin->release = '1.0';                // Versão do release do plugin.
