...
/**
 * Strings for component 'portfolio_boxnet', language 'pt_br', version '4.4'.
 *
...
$string['setupinfodetails'] = 'Para obter um ID e segredo do cliente, faça login no Box e visite a <a href="{$a->servicesurl}">página de desenvolvedores do Box</a>. Siga "Criar nova aplicação" e crie uma nova aplicação para o seu site Moodle. O ID e o segredo do cliente são exibidos na seção "Parâmetros do OAuth2" do formulário de edição da aplicação. Opcionalmente, você também pode fornecer outras informações sobre o seu site Moodle.';
