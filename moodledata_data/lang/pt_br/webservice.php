...
/**
 * Strings for component 'webservice', language 'pt_br', version '4.4'.
 *
 * @package     webservice
 * @category    string
...
$string['tokennamehint'] = 'Se você não inserir um nome, um nome aleatório será usado.';
$string['tokennameprefix'] = 'Webservice-{$a}';
$string['tokennewmessage'] = 'Copie o token agora. Ele não será exibido novamente quando você sair desta página.';
...
$string['validuntil_empty'] = 'Este token não tem data de validade.';
