...
/**
 * Strings for component 'scheduler', language 'pt_br', version '4.4'.
 *
 * @package     scheduler
 * @category    string
...
<p>utilizando o agendador intitulado "<em><a href="{$a->scheduler_url}">{$a->module}</a></em>" no site: <a href="{$a->site_url}">{$a->site}</a>.</p>';
