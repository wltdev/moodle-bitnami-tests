...
/**
 * Strings for component 'tool_uploaduser', language 'pt_br', version '4.4'.
 *
...
$string['duplicateemail'] = 'Múltiplos usuários com {$a} e-mails detectados';
...
$string['invaliduserdatavalues'] = 'Dados inválidos detectados para o usuário \'{$a->username}\' ({$a->values}). Estes dados foram corrigidos ou excluídos.';
$string['linex'] = 'Linha {$a}';
$string['matchemail'] = 'Coincidir com o endereço de e-mail';
...
$string['uunoemailduplicates'] = 'Proibir duplicação de endereços de e-mail';
