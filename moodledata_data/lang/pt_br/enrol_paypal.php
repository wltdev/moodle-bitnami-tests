...
/**
 * Strings for component 'enrol_paypal', language 'pt_br', version '4.4'.
 *
...
$string['businessemail'] = 'PayPal business e-mail';
$string['businessemail_desc'] = 'O endereço de e-mail de sua conta de negócios PayPal';
...
$string['privacy:metadata:enrol_paypal:enrol_paypal:business'] = 'Endereço de e-mail ou ID da conta do PayPal do destinatário do pagamento (ou seja, o vendedor).';
...
$string['privacy:metadata:enrol_paypal:enrol_paypal:receiver_email'] = 'Endereço de e-mail principal do destinatário do pagamento (ou seja, o comerciante).';
...
$string['privacy:metadata:enrol_paypal:paypal_com:email'] = 'Endereço de e-mail do usuário que está comprando o curso.';
