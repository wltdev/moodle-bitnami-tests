...
/**
 * Strings for component 'hub', language 'pt_br', version '4.4'.
 *
 * @package     hub
 * @category    string
...
$string['siteregistrationemail_help'] = 'Você tem a opção de assinar nossa lista de e-mails para receber notificações de novos lançamentos do Moodle, alertas de segurança e outras notícias importantes. Você pode cancelar sua assinatura a qualquer momento.';
