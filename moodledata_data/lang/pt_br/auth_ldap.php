...
/**
 * Strings for component 'auth_ldap', language 'pt_br', version '4.4'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['noemail'] = 'A tentativa de lhe enviar um e-mail falhou!';
...
$string['sync_updateuserchunk'] = 'Defina esse valor para o número de usuários que você deseja atualizar por transação. Definir como 0 atualizará todos os usuários em uma transação.';
$string['sync_updateuserchunk_key'] = 'Tamanho do bloco de atualização de sincronização de usuários';
