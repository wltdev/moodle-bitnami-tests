...
/**
 * Strings for component 'assignfeedback_editpdf', language 'pt_br', version '4.4'.
 *
...
$string['pathtogserror'] = 'O caminho configurado para o Ghostscript não está corretamente definido: {$a}';
