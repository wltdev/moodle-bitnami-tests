...
/**
 * Strings for component 'qcreate', language 'pt_br', version '4.4'.
 *
 * @package     qcreate
 * @category    string
...
Você pode vê-la na página de atividade:
    ...
    {$a->url}';
$string['gradecomment'] = 'Comentário para a questão "{$a->qname}" criado por {$a->user}';
...
$string['questiongrade'] = 'Nota para a questão "{$a->qname}" criada por {$a->user}';
