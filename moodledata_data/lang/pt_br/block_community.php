...
/**
 * Strings for component 'block_community', language 'pt_br', version '4.4'.
 *
...
$string['errorcourselisting'] = 'Observação: Não é mais possível procurar por cursos comunitários no moodle.net. Os cursos anteriormente compartilhados para download agora estão disponíveis em archive.moodle.net. Consulte <a href="https://docs.moodle.org/en/Sunsetting_moodle.net">Desativação do moodle.net</a> para mais detalhes.';
