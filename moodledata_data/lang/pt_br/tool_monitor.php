...
/**
 * Strings for component 'tool_monitor', language 'pt_br', version '4.4'.
 *
...
$string['messagetemplate_help'] = 'Uma mensagem de notificação é enviada aos assinantes assim que o limite de notificação é atingido. Pode incluir qualquer um ou todos os seguintes espaços reservados:

* Link para a localização do evento {link}
* Link para a área monitorada {modulelink}
* Nome do módulo do curso {modulename}
* Nome da regra {rulename}
* Descrição {description}
* Evento {eventname}
* Nome completo do curso {coursefullname}
* Nome curto do curso {courseshortname}';
