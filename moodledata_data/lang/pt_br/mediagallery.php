...
/**
 * Strings for component 'mediagallery', language 'pt_br', version '4.4'.
 *
...
$string['errortoomanygalleries'] = 'Desculpe, você ou seu grupo excedeu o número máximo de galerias permitidas nesta coleção ({$a}).';
$string['errortoomanyitems'] = 'Desculpe, esta galeria já atingiu o número máximo de itens permitidos ({$a}).';
