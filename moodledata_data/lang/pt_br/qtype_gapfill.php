...
/**
 * Strings for component 'qtype_gapfill', language 'pt_br', version '4.4'.
 *
...
$string['yougotnrightcount'] = 'Você completou {$a->num} {$a->gaporgaps} corretamente de um total de {$a->outof}.';
