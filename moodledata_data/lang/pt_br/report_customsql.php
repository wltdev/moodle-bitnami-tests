...
/**
 * Strings for component 'report_customsql', language 'pt_br', version '4.4'.
 *
...
$string['userhasnothiscapability'] = 'O usuário "{$a->name}" ({$a->userid}) não possui a capacidade "{$a->capability}". Por favor, remova este usuário da lista ou altere a escolha em "{$a->whocanaccess}".';
