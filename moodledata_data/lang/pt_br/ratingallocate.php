...
/**
 * Strings for component 'ratingallocate', language 'pt_br', version '4.4'.
 *
...
$string['allocation_statistics_description'] = 'Esta estatística dá uma impressão da satisfação geral da alocação.
Está contando as alocações de acordo com a classificação que o usuário deu à escolha respectiva.
<ul>
<li>{$a->rated} de {$a->usersinchoice} usuário(s) deram seu voto.</li>
<li>{$a->users} de {$a->total} usuário(s) receberam uma escolha que classificaram como "{$a->rating}".</li>
<li>{$a->unassigned} usuário(s) ainda não puderam ser alocados a uma escolha.</li>
</ul>';
...
$string['edit_choice'] = 'Editar escolha';
