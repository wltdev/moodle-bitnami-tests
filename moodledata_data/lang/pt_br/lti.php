...
/**
 * Strings for component 'lti', language 'pt_br', version '4.4'.
 *
 * @package     lti
 * @category    string
...
$string['accept_grades_from_tool'] = 'Permitir que {$a} adicione notas no livro de notas';
...
$string['courseexternaltooladd'] = 'Adicionar nova ferramenta externa LTI';
$string['courseexternaltooladdsuccess'] = 'Ferramenta {$a} adicionada.';
$string['courseexternaltooledit'] = 'Editar {$a}';
$string['courseexternaltooleditsuccess'] = 'As alterações foram salvas.';
$string['courseexternaltooliconalt'] = 'Ícone para a ferramenta externa LTI {$a}.';
$string['courseexternaltools'] = 'Ferramentas externas LTI';
$string['courseexternaltoolsinfo'] = 'As ferramentas externas LTI são aplicativos complementares que você pode integrar ao seu curso, como conteúdo interativo ou avaliações. Seus estudantes podem acessá-los e usá-los sem sair do seu curso.';
$string['courseexternaltoolsnoeditpermissions'] = 'Você não tem permissão para editar esta ferramenta';
$string['courseexternaltoolsnoviewpermissions'] = 'Ver ferramentas externas do curso';
...
$string['coursetooldeleted'] = 'Ferramenta externa {$a} excluída';
...
$string['deletecoursetool'] = 'Excluir {$a}';
$string['deletecoursetoolconfirm'] = 'Isso excluirá {$a} das ferramentas LTI disponíveis em seu curso.';
$string['deletecoursetoolwithusageconfirm'] = '{$a} está atualmente sendo utilizado em pelo menos uma atividade no seu curso. Se você excluir essa ferramenta, as atividades que a utilizam deixarão de funcionar.<br><br>Tem certeza de que deseja excluir {$a}?';
$string['deletetype'] = 'Excluir ferramenta externa pré-configurada';
$string['display_description'] = 'Exibir a descrição da atividade quando os estudantes acessarem a ferramenta';
$string['display_description_help'] = 'O conteúdo desta ferramenta é exibido incorporado em uma página no curso. Esta configuração determina se a descrição da atividade será exibida nessa página.';
$string['display_name'] = 'Exibir o nome da atividade quando os estudantes acessarem a ferramenta';
$string['display_name_help'] = 'O conteúdo desta ferramenta é exibido incorporado em uma página no curso. Esta configuração determina se o nome da atividade é mostrado nessa página.';
...
$string['editmanualinstancedeprecationwarning'] = 'Atividades de ferramentas externas configuradas manualmente não são mais suportadas. Não se preocupe, esta atividade continuará funcionando como está, mas você não poderá mais fazer alterações na configuração da ferramenta aqui.
<br><br>Para fazer qualquer alteração na ferramenta ou criar novas atividades com ela, a ferramenta precisa ser adicionada ao seu curso em Curso > Mais > Ferramentas externas LTI. Em seguida, você poderá criar novas atividades, selecionando a ferramenta diretamente no Seletor de atividades.<br><br>Você pode ler mais sobre a adição de ferramentas externas LTI na documentação <a href="{$a}" target="_blank">Ferramenta externa</a>.';
$string['edittype'] = 'Editar ferramenta pré-configurada';
$string['embed'] = 'Incorporar';
$string['embed_no_blocks'] = 'Incorporar sem blocos';
$string['enableemailnotification'] = 'Enviar notificação por e-mails';
$string['enableemailnotification_help'] = 'Caso habilitado, estudantes irão receber notificações por e-mail quando a ferramenta de submissão receber notas';
...
$string['lti:addmanualinstanceprohibitederror'] = 'A criação manual de ferramentas sem uma definição de ferramenta de curso não é mais suportada. Por favor, crie primeiro uma ferramenta de curso e depois a utilize para criar instâncias de atividades.';
...
$string['nocourseexternaltoolsnotice'] = 'Ainda não há ferramentas externas LTI.';
...
$string['privacy:metadata:email'] = 'O endereço de e-mail do usuário que acessa o LTI consumidor';
...
$string['restricttocategory_help'] = 'Para restringir o uso desta ferramenta a cursos dentro de uma categoria, selecione a categoria ou categorias na lista.';
...
$string['selectcontentvalidationerror'] = 'Você precisa selecionar conteúdo para esta atividade.';
$string['send'] = 'Enviar';
...
$string['share_email'] = 'Compartilhar e-mail da inicialização com ferramenta';
$string['share_email_admin'] = 'Compartilhar e-mail de inicialização com ferramenta';
...
$string['tooltypenotfounderror'] = 'A ferramenta LTI usada nesta atividade foi excluída. Se precisar de ajuda, entre em contato com seu professor ou administrador do site.';
