...
/**
 * Strings for component 'mnet', language 'pt_br', version '4.4'.
 *
 * @package     mnet
 * @category    string
...
$string['mnetidproviderdesc'] = 'Você pode usar este recurso para obter um link no qual você pode fazer login se puder informar o endereço correto de e-mail que case com o nome de usuário com o qual você tentou efetuar o login anteriormente.';
