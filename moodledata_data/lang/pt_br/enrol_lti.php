...
/**
 * Strings for component 'enrol_lti', language 'pt_br', version '4.4'.
 *
 * @package     enrol_lti
 * @category    string
...
$string['adddeployment:deploymentid'] = 'ID de implantação';
...
$string['cookiesarerequiredinfo'] = 'Esta ferramenta não pode ser iniciada porque seu navegador parece estar bloqueando cookies de terceiros.<br><br>
...
$string['provisioningmodestudentlaunch'] = 'Estudante inicia primeiro modo de provisionamento';
