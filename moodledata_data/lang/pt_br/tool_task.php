...
/**
 * Strings for component 'tool_task', language 'pt_br', version '4.4'.
 *
 * @package     tool_task
 * @category    string
...
$string['runadhoctasks'] = 'Executar todas as tarefas \'{$a}\'';
$string['runadhoctasksfailed'] = 'Executar tarefas \'{$a}\' que falharam';
