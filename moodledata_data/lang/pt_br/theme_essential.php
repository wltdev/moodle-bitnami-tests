...
/**
 * Strings for component 'theme_essential', language 'pt_br', version '4.4'.
 *
...
$string['fontselectdesc'] = 'Escolha a partir da lista de mecanismos de definição de fontes disponíveis:<ul><li>As "Fontes do usuário" são aquelas em que a fonte já está instalada na máquina do usuário, e você apenas especifica o nome dela.</li><li>As "Fontes da web do Google" são aquelas em que você encontra uma fonte em "{$a->googlewebfonts}" e especifica o nome dela.</li><li>As "Fontes personalizadas" são aquelas em que você especifica o nome e faz o upload dos arquivos da fonte.</li></ul>Por favor, salve para exibir as opções de sua escolha.';
