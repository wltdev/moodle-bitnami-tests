...
/**
 * Strings for component 'block_autoattend', language 'pt_br', version '4.4'.
 *
...
$string['email_teacher_attend'] = 'Os dados de presença de {$a->fullname} [{$a->date} {$a->starttm}-{$a->endtm}] estão anexados a este e-mail.';
$string['email_teacher_key'] = 'A palavra-chave de {$a->fullname} [{$a->date} {$a->starttm}-{$a->endtm}] é {$a->key}';
$string['email_teacher_key_html'] = 'A palavra-chave de {$a->fullname} [{$a->date} {$a->starttm}-{$a->endtm}] é <strong>{$a->key}</strong>';
$string['endtime'] = 'Fim';
