...
/**
 * Strings for component 'auth_mnet', language 'pt_br', version '4.4'.
 *
 * @package     auth_mnet
 * @category    string
...
$string['privacy:metadata:mnet_external:email'] = 'Um endereço de e-mail para contato.';
$string['privacy:metadata:mnet_external:emailstop'] = 'Uma preferência para impedir que o e-mail seja enviado ao usuário.';
...
$string['privacy:metadata:mnet_external:maildigest'] = 'Uma configuração para o resumo de e-mail para este usuário.';
$string['privacy:metadata:mnet_external:maildisplay'] = 'Uma preferência para o usuário em mostrar o endereço de e-mail para outros usuários.';
