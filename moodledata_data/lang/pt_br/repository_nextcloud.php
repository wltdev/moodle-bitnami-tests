...
/**
 * Strings for component 'repository_nextcloud', language 'pt_br', version '4.4'.
 *
...
$string['contactadminwith'] = 'A ação solicitada não pôde ser executada. Se isso acontecer repetidamente, por favor, entre em contato com o administrador do site com as seguintes informações adicionais:<br>"<i>{$a}</i>".';
