...
/**
 * Strings for component 'tool_moodlenet', language 'pt_br', version '4.4'.
 *
...
$string['autoenablenotification'] = '<p>A partir do Moodle 4.0, a integração com o <a href="https://moodle.net/">MoodleNet</a> é habilitada por padrão em Recursos avançados. Usuários com permissão de criar e gerenciar atividades podem navegar no MoodleNet por meio do seletor de atividades e importar recursos do MoodleNet para seus cursos.</p><p>Se você desejar, uma instância alternativa do MoodleNet pode ser definida nas <a href="{$a->settingslink}">configurações de entrada do MoodleNet</a>.</p>';
...
$string['enablemoodlenet'] = 'Ativar integração com o MoodleNet';
...
$string['importconfirm'] = 'Você está prestes a importar o conteúdo "{$a->resourcename} ({$a->resourcetype})" para o curso "{$a->coursename}". Tem certeza de que deseja continuar?';
