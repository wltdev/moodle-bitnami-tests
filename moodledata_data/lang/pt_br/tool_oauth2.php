...
/**
 * Strings for component 'tool_oauth2', language 'pt_br', version '4.4'.
 *
 * @package     tool_oauth2
 * @category    string
...
$string['acceptrisk'] = 'Entendo que desabilitar a verificação de e-mail pode ser um problema de segurança.';
...
$string['issuerloginscopes_help'] = 'Alguns sistemas exigem escopos adicionais para uma solicitação de login para ler o perfil básico do usuário. Os escopos padrão para um sistema compatível com OpenID Connect são "e-mail de perfil openid".';
