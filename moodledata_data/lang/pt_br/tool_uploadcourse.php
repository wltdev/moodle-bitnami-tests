...
/**
 * Strings for component 'tool_uploadcourse', language 'pt_br', version '4.4'.
 *
...
$string['courseuploadnotallowed'] = 'Sem permissão para fazer upload de cursos na categoria: {$a}';
$string['courseuploadupdatenotallowed'] = 'Já existe um curso com este nome breve, e você não tem permissão para usar a funcionalidade de upload de curso para atualizá-lo.';
...
$string['errorunsupportedmethod'] = 'O método de inscrição \'{$a}\' não é compatível com upload de CSV';
...
$string['uploadcourse:use'] = 'Utilize a ferramenta de upload de curso.';
