...
/**
 * Strings for component 'tool_generator', language 'pt_br', version '4.4'.
 *
...
$string['testscenario_filedesc'] = 'Os arquivos de recursos enviados podem conter apenas cenários com etapas de geração de dados principais. Ainda não é compatível com esquemas de cenários. Todos os cenários serão executados de uma vez, mas  as etapas do plano de fundo serão ignoradas.';
